...
# docker build -t bu_cicd_apache:latest .


# Run the container with the webapp:
# docker run -d -it -p 80:80 bu_cicd_apache
...
WORKDIR /var/www/bu_cicd_apache

# Copy over and install the requirements
COPY . /var/www/bu_cicd_apache/
RUN pip3 install -r /var/www/bu_cicd_apache/requirements.txt
...
RUN chown -R www-data:www-data /var/www/bu_cicd_apache
